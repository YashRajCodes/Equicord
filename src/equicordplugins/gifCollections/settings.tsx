...
export const settings = definePluginSettings({
    ...
    exportGifs: {
        ...
        component: () => <Button onClick={downloadCollections}>Export Collections</Button>
    },
    resetCollections: {
        type: OptionType.COMPONENT,
        ...
        <div className={cl("sort-container")}>
            ...
            <div className={cl("sort-section")}>
                ...
                <RadioOption
                    ...
                    onChange={() => handleSortType(SortingOptions.NAME)}
                    label="Name"
                />
                <RadioOption
                    name="sortType"
                    ...
                    onChange={() => handleSortType(SortingOptions.CREATION_DATE)}
                    label="Creation Date"
                />
                <RadioOption
                    name="sortType"
                    ...
                    onChange={() => handleSortType(SortingOptions.MODIFIED_DATE)}
                    label="Modified Date"
                />
            </div>
            <Divider className={cl("sort-divider")} />
