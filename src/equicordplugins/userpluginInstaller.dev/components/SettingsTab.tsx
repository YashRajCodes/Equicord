        ...
        >
            <div className={cl("update-check-container")}>
                {isObjectEmpty(pluginsWithUpdates) ? (
                    !updatesLoaded && <BaseText>Checking for updates...</BaseText>
                ) : (
            ...
            <Card className={cl("info-card")}>
                ...
                <Paragraph className={cl("install-desc")}>
                    You can install a plugin from GitHub, GitLab, Codeberg, git.nin0.dev, or plugins.nin0.dev by pasting
                    its clone URL here.
                </Paragraph>
                    ...
                    <div className={cl("plugins-grid")}>
                        {plugins
                            ...
                            .toSorted((a, b) => {
                                ...
                                const [aa, bb] = [
                                    updatePendingNames.includes(a.directory!) ? 1000 : 0,
                                    updatePendingNames.includes(b.directory!) ? 1000 : 0
                                ];
                                return bb - aa;
                            })
                            .map(plugin => {
                                    ...
                                    <AddonCard
                                        ...
                                        footer={
                                            <div className={cl("plugin-footer")}>
                                                {Object.keys(pluginsWithUpdates).includes(plugin.directory!) && (
                                                    <Button
                                                        size="small"
                                                        onClick={async () => {
                                                            try {
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => VencordNative.native.openExternal(plugin.remote)}
                                                >
                                                    Source
                                                </Button>
                                                {plugin.supportChannelID && (
                                                    <Button
                                                        variant="secondary"
                                                        size="small"
                                                        onClick={() => {
                                                            ...
                                                            NavigationRouter.transitionTo(
                                                                `/channels/1015060230222131221/${plugin.supportChannelID}`
                                                            );
                                                        }}
                                                    >
                                                        Support
