            ...
            {songData ? (
                ...
                >
                    <div>
                        ...
                        >
                            {Object.keys(songData.links).map(
                                service =>
                                    settings.store.servicesSettings[service].enabled && (
                                        <Button
                                            key={`${service}-${url}`}
                                            style={{
                                            ...
                                            onClick={() => {
                                                ...
                                                VencordNative.native.openExternal(
                                                    settings.store.servicesSettings[service].openInNative &&
                                                        Providers[service].native
                                                        ? songData.links[service].nativeUri
                                                        : songData.links[service].url
                                                );
                                            }}
                                        >
                                            <img
                ...
                <BaseText>Loading song link...</BaseText>
            )}
        </BaseText>
    );
}
