...
export const settings = definePluginSettings({
    ...
    attachmentFileExtensions: {
        ...
        type: OptionType.STRING,
        description:
            "Comma separated list of file extensions to save. Attachments with file extensions not in this list will not be saved.",
    ...
    openLogs: {
        ...
        component: () => <Button onClick={() => openLogModal()}>Open Logs</Button>
    },
