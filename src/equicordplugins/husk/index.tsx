...
export function Husk(props: IconProps) {
    return (
        <Icon {...props} className={classes(props.className, "vc-husk")} viewBox="0 0 24 24">
            <path
                fill="currentColor"
    ...
    messagePopoverButton: {
        ...
        render(msg) {
            return {
                ...
                onClick: () => {
                    const guildId =
                        ChannelStore.getChannel(msg.channel_id).guild_id !== null
                            ? ChannelStore.getChannel(msg.channel_id).guild_id
                            : "";
                    RestAPI.put({
