    ...
    return (
        <svg {...iconProps}>
            <g fill="none" fillRule="evenodd">
                ...
                <path d="m0 8h14.2l-3.6-3.6 1.4-1.4 6 6-6 6-1.4-1.4 3.6-3.6h-14.2" fill="currentColor" />
            </g>
        </svg>
    );
}
...
function LeaveIcon() {
    return (
        <svg {...iconProps}>
            <g fill="none" fillRule="evenodd">
                <path d="m18 0h-18v18h18z" />
                <path d="m3.8 8 3.6-3.6-1.4-1.4-6 6 6 6 1.4-1.4-3.6-3.6h14.2v-2" fill="currentColor" />
            </g>
        </svg>
    );
}
...
function DeafenIcon() {
    return (
        <svg {...iconProps} viewBox="0 0 24 24">
            <path
                d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H3v-7zM21 14h-3a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h3v-7z"
                fill="currentColor"
            />
...
function ActivityIcon() {
    return (
        <svg {...iconProps} viewBox="0 0 24 24">
            ...
            <path
                d="M18.5 14c.2-.7.8-.7 1 0l.4 1.1 1.1.4c.7.2.7.8 0 1l-1.1.4-.4 1.1c-.2.7-.8.7-1 0l-.4-1.1-1.1-.4c-.7-.2-.7-.8 0-1l1.1-.4z"
                fill="currentColor"
            />
        </svg>
    );
...
export default function EventIcon({ type }: { type: LogEventType }) {
    ...
    return (
        <div className={classes(cl("icon"), cl(`icon-${colorMap[type]}`))}>
            <IconComponent />
        </div>
    );
}
