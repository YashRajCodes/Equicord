        ...
        return (
            <div className={"vc-cmt-demo-message-container"} onClick={() => setIsCompact(!isCompact)}>
                <DemoMessage
                    compact={isCompact}
                    msgId={"1337"}
                    message={`Click me to switch to ${isCompact ? "cozy" : "compact"} mode`}
                    isGroupStart={true}
                ...
                <DemoMessage
                    compact={isCompact}
                    msgId={"1338"}
                    message={"This message was sent in the last week"}
                    isGroupStart={true}
                ...
                <DemoMessage
                    compact={isCompact}
                    msgId={"1339"}
                    message={"Hover over timestamps to see tooltip formats"}
                    isGroupStart={true}
                ...
                <DemoMessage
                    compact={isCompact}
                    msgId={"1340"}
                    message={"Edit the formats below to see them live update here"}
                    isGroupStart={true}
                    date={today.current}
                />
            </div>
