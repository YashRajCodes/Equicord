...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace:
                    "children:$self.renderUsername({username:$1,user:$2,showMeYourNameMention:typeof showMeYourNameMention!=='undefined'?showMeYourNameMention:undefined})"
            }
        },
        {
            find: ".ROLE_MENTION)",
    ...
    renderUsername: ErrorBoundary.wrap(
        ({
            ...
            const nameContent =
                isPluginEnabled(showMeYourName.name) && showMeYourNameMention ? (
                    showMeYourNameMention
                ) : (
