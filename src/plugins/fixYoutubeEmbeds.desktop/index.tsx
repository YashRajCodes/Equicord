...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace:
                    "$2 break; case $1: $3 = $self.ToggleableDescriptionWrapper({ embed: this.props.embed, original: $4.bind(this) }); break; default: $3 = $4() }"
            }
        }
    ],
    ToggleableDescription: ErrorBoundary.wrap(({ embed, original }: ToggleableDescriptionProps) => {
        ...
        return (
            <div style={{ cursor: "pointer", marginTop: isOpen ? "0px" : "8px" }} onClick={() => setOpen(o => !o)}>
                {isOpen ? original() : embed.rawDescription.substring(0, 20) + "..."}
            </div>
        );
    }),
