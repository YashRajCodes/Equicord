        ...
        >
            ...
            <div className={cl("tab-content")}>
                ...
                {currentTab === Tabs.MutualMembers && (
                    <MutualMembersTab guild={guild} setCount={setMutualMembersCount} />
                )}
    ...
    const sortedMembers = members
        ...
        .sort((a, b) => {
            switch (settings.store.sorting) {
                ...
                case "displayname":
                    return (
                        a?.globalName?.localeCompare(b?.globalName || b.username) ||
...
function MutualServerIcons({ member }: { member: MemberWithMutuals }) {
    ...
    return (
        <div className={cl("mutual-guilds")}>
            ...
            {mutualCount > MAX_ICONS && <div className={cl("guild-count")}>+{mutualCount - MAX_ICONS}</div>}
        </div>
    );
}
            ...
            {members
                ...
                .sort((a, b) => {
                    switch (settings.store.sorting) {
                        ...
                        case "displayname":
                            return (
                                a.user?.globalName?.localeCompare(b.user?.globalName || b.user.username) ||
                ...
                .map(member => (
                    <div className={cl("member-row")} key={member.id} onClick={() => openUserProfile(member.id)}>
