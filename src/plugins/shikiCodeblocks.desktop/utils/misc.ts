...
export const requireHljs = extractAndLoadChunksLazy(
    ["codeBlock:{react("],
    new RegExp(`"hljs".+?${DefaultExtractAndLoadChunksRegex.source}`)
);

export const shouldUseHljs = ({ lang, tryHljs }: { lang: HighlighterProps["lang"]; tryHljs: HljsSetting }) => {
